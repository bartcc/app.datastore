<div id="header">
    <div id="test" class="top">
        <h1>A nice Datastore In The Wild</h1>
        ...
        <?php $login_btn = $form->submit('Show Login', array('div' => false, 'id' => 'login-trigger', 'class' => 'down primary_lg big window bl', 'after' => $pin_btn)); ?>
